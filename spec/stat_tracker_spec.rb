...
RSpec.describe StatTracker do
    ...
    describe '#.from_csv' do
      ...
      xit "can calculate highest sum of the winning and losing teams’ scores" do
        expect(@stat_tracker.highest_total_score).to eq 11
      end

      xit "can calculate lowest sum of the winning and losing teams’ scores" do

      end

      xit "can calculate the percentage of games that a home team has won (rounded to the nearest 100th)" do

      end

      xit "can calculate the percentage of games that a visitor has won (rounded to the nearest 100th)" do

      end

      xit "can calculate the percentage of games that has resulted in a tie (rounded to the nearest 100th)" do

      end

      xit "can store games by season" do

      end

      xit "can averae goals per game" do 
